...
int main()
{
    ...
    for (;;) {
        // Test the log system - It works - Don't need it printing all the time anymore. 
        // log(LogLevel::INFORMATION, "Hello world");

        // gpio_init(SW1)
        // gpio_set_irq_enabled_with_callback(SW1, GPIO_IRQ_EDGE_FALL, true, &button_callback);
        // using switch statement and case, led, accel...
        // switch statement changing between LED_task.cpp and accelerometer_task.cpp (& Microphone_task.cpp)

        // NEED TO HAVE LEDS AND ACCELEROMETER TASKS IN SEPARATE FILES, AND THEN CALL THEM HERE.
        ...
        // 4 bytes of data to read 1, therefore would need 24...
        // with multibyte, 9 would need to go through. 
        // extra bit to set to recieve multi-byte read. 
        // want to set +/- 2G, 
        // ctrl_reg0 -> default set to 1 (which i default)
